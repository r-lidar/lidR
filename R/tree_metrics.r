...
tree_metrics.LAScatalog = function(las, func, field = "treeID")
{
  ...
  output <- catalog_apply2(las, tree_metrics, func = substitute(func), field = field, need_buffer = TRUE, check_alignment = FALSE, drop_null = TRUE, globals = names(glob$globals))
