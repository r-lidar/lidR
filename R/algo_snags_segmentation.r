                    ...
                    pt_den_req = 3, BBPRthrsh_mat = NULL)
{
  ...
  assertive::assert_all_are_in_closed_range(neigh_radii, 0, 10)
  assertive::assert_is_a_number(low_int_thrsh)
  assertive::assert_all_are_in_closed_range(low_int_thrsh, 0, 255)
  assertive::assert_is_a_number(uppr_int_thrsh)
  assertive::assert_all_are_in_closed_range(uppr_int_thrsh, 0, 255)
