...
#' WARNING: there is no buffer mechanism to protect the process against edge artifacts. See section "Edge artifacts".
#'
#' @section Unix:
#'
...
#' @param platform character. Can be "windows" or "unix". Default is autodetect. See sections "Details", "Unix" and  "Windows".
