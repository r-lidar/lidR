...
#' Default is +Inf (no triming), meaning that the whole range of values is used for the color
#' palette. 10 means that the values greater than 10 are all in the higest color.
