...
test_that("knnidw works", {
  ...
  val1 = lidR:::knnidw(X,Y, Z, 0.1, 0.1, 1, 1)
  val2 = lidR:::knnidw(X,Y, Z, 0.2, 0.2, 1, 1)
  val3 = lidR:::knnidw(X,Y, Z, 0.3, 0.3, 1, 1)
  val4 = lidR:::knnidw(X,Y, Z, 0.4, 0.5, 1, 1)
  ...
  val1 = lidR:::knnidw(X,Y, Z, 0.25, 0.25, 2, 1)
  val2 = lidR:::knnidw(X,Y, Z, 0.2, 0.2, 2, 1)

  expect_equal(val1, 0.25)
  expect_equal(val2, 0.2)

  lidR:::knnidw(X,Y, Z, 0.25, 0.25, 2, 1)
})
