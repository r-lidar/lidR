...
#' \itemize{
#' \item \strong{tiling_size}: How much data is loaded at once.
#' \item buffer: This function guarantee a strict wall-to-wall continous output. The \code{buffer} option
#' is not considered.
...
#' \code{YBOTTOM}, \code{YTOP}, \code{XCENTER}, \code{YCENTER} \code{ID} and, if tiling is size equal to 0
