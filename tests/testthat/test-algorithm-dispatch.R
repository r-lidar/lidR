...
test_that("An error is thrown if algorithms are called in wrong context", {
  ...
  expect_error(find_trees(las, h), "The algorithm used is not an algorithm for individual tree detection.")
...
test_that("An error is thrown if the input is not an algorithm", {
  expect_error(find_trees(las, mean), "Invalid function provided as algorithm.")
  expect_error(find_trees(las, 3), "Invalid function provided as algorithm.")
