...
#'
#' Individual tree segmentation using the Li et al. (2012) algorithm (see reference). This method is
#' a growing region method working at the point cloud level. It is an implementation (as strict as
#' possible) of the Li et al. 2012 (see references) algorithm made by the \code{lidR}
...
lastrees_li = function(las, dt1 = 1.5, dt2 = 2, R = 2, Zu = 15, hmin = 2, speed_up = 10, ...)
{
  stopifnotlas(las)
