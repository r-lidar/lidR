...
#' is an allowed string even if it refers to three attributes simultaneously. Also FWF is
#' recognized to render full waveform if the object contains such.
...
plot.LAS = function(x, y, color = "Z", colorPalette = "auto", bg = "black", trim = Inf, backend = "rgl", clear_artifacts = TRUE, nbits = 16, axis = FALSE, legend = FALSE, add = FALSE, ...)
{
  ...
  if (autocol)
  {
    ...
    else if (color  == "Classification")
    {
      ...
      colorPalette = grDevices::colorRampPalette(c("white", "red"))(50)
    else
      colorPalette = height.colors(50)
  }
